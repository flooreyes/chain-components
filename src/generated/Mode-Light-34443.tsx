...
export const ModeLightIcon = (props) => {
    return (
        ...
        <path d="M368.443 387.632H313.495V263.418L335.494 192.566L319.887 187.016L248.638 387.632H206.82L135.522 187.016L119.964 192.566L141.963 263.418V387.682H87.0156V138.361H168.818L219.554 281.057V322.974H236.152V281.057L286.888 138.361H368.69V387.632H368.443Z" fill="url(#paint1_linear_722_162)"/>
        <defs>
        <radialGradient id="paint0_radial_722_162" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(279.881 135.027) rotate(97.5876) scale(394.019 341.233)">
