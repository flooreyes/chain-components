...
export const FantomDarkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
    return (
        ...
        <stop offset="1" stopColor="#0B6786"/>
        </linearGradient>
