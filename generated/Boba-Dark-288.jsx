...
//@ts-ignore
export const BobaDarkIcon = (props) => {
    return (
        <svg id="288"  viewBox="0 0 456 526" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M202.637 14.6056C218.107 5.67399 237.167 5.67399 252.637 14.6056L430.033 117.025C445.503 125.957 455.033 142.463 455.033 160.327V365.171C455.033 383.035 445.503 399.542 430.032 408.473L252.635 510.886C237.166 519.817 218.107 519.817 202.638 510.886L25.2414 408.473C9.77069 399.542 0.240234 383.035 0.240234 365.171V160.327C0.240234 142.463 9.77019 125.957 25.2402 117.025L202.637 14.6056Z" fill="url(#paint0_radial_738_292)"/>
        ...
        <defs>
        <radialGradient id="paint0_radial_738_292" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(439.725 -44.1421) rotate(111.621) scale(612.561 648.617)">
        <stop stopColor="#5D6D3C"/>
        ...
        <radialGradient id="paint3_radial_738_292" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(340.376 63.1099) rotate(110.682) scale(482.693 295.225)">
        <stop stopColor="#4B5732"/>
        <stop offset="1" stopColor="#151515"/>
        </radialGradient>
        </defs>
        </svg>
