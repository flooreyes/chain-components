...
export const BSCDarkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
    return (
        ...
        <path d="M202.601 14.4806C218.071 5.54899 237.131 5.54899 252.601 14.4806L429.997 116.9C445.467 125.832 454.997 142.338 454.997 160.202V365.046C454.997 382.91 445.467 399.417 429.996 408.348L252.599 510.761C237.13 519.692 218.071 519.692 202.602 510.761L25.2053 408.348C9.73456 399.417 0.204102 382.91 0.204102 365.046V160.202C0.204102 142.338 9.73404 125.832 25.2041 116.9L202.601 14.4806Z" fill="url(#paint1_radial_718_93)"/>
        <path d="M109.583 262.62L109.772 331.907L168.645 366.55V407.114L75.3179 352.378V242.359L109.583 262.62ZM109.583 193.334V233.709L75.2969 213.427V173.052L109.583 152.77L144.038 173.052L109.583 193.334ZM193.231 173.052L227.517 152.77L261.972 173.052L227.517 193.334L193.231 173.052Z" fill="url(#paint2_radial_718_93)"/>
        ...
        <defs>
        <radialGradient id="paint0_radial_718_93" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(307.886 298.947) rotate(106.662) scale(40.3866 32.8443)">
        ...
        <stop offset="1" stopColor="#8A6A06"/>
        </radialGradient>
        ...
        <radialGradient id="paint4_radial_718_93" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(309.096 294.099) rotate(104.661) scale(50.1205 30.6225)">
        <stop stopColor="#FFF9F9"/>
        <stop offset="1" stopColor="#DBDBDB"/>
        </radialGradient>
