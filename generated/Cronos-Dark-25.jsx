...
export const CronosDarkIcon = (props) => {
    return (
        ...
        <path d="M227.708 103.865L90.0146 183.365V342.365L227.708 421.865L365.172 342.365V183.365L227.708 103.865ZM324.391 318.767L227.479 374.669L130.796 318.767V206.963L227.708 151.061L324.391 206.963V318.767Z" fill="url(#paint1_radial_722_203)"/>
        ...
        <defs>
        <radialGradient id="paint0_radial_722_203" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(175.603 481.676) rotate(-62.1466) scale(544.462 471.521)">
