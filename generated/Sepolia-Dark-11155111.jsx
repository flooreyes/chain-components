...
export const SepoliaDarkIcon = (props) => {
    return (
        ...
        <path d="M227.507 97.0391L225.277 104.612V324.351L227.507 326.576L329.505 266.284L227.507 97.0391Z" fill="#F38A75"/>
        <path d="M227.507 97.0391L125.506 266.284L227.507 326.576V219.921V97.0391Z" fill="#F9ED67"/>
