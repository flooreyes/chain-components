...
export const BaseLightIcon = (props) => {
    return (
        ...
        <path d="M227.696 422.257C315.668 422.257 386.976 351.076 386.976 263.257C386.976 175.438 315.668 104.257 227.696 104.257C144.24 104.257 75.7813 168.34 68.9761 249.888H279.505V276.626H68.9761C75.7813 358.173 144.24 422.257 227.696 422.257Z" fill="url(#paint1_radial_705_125)"/>
        <path d="M227.696 422.257C315.668 422.257 386.976 351.076 386.976 263.257C386.976 175.438 315.668 104.257 227.696 104.257C144.24 104.257 75.7813 168.34 68.9761 249.888H279.505V276.626H68.9761C75.7813 358.173 144.24 422.257 227.696 422.257Z" fill="#0151FE"/>
        <defs>
        <linearGradient id="paint0_linear_705_125" x1="266.078" y1="182.991" x2="77.7535" y2="506.74" gradientUnits="userSpaceOnUse">
        <stop stopColor="white"/>
        <stop offset="1" stopColor="#6194FD"/>
        </linearGradient>
